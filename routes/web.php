...
Route::get('/', [stateController::class,'index'])->name('layout.state');
...
Route::delete('/state/{id}/delete', [stateController::class,'destroy'])->name('layout.Statedelete');
...
Route::delete('/city/{id}/delete', [cityController::class, 'destroy'])->name('layout.cityDelete');
